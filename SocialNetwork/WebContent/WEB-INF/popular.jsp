...
<html lang="en" dir="ltr">
  ...
  <body onload="color()">
        ...
        <jsp:include page="header.jsp">
          <jsp:param name="Popular" value="active"/>
        </jsp:include>
        <!--end of header***********************************-->
    ...
    <div class="container">
      ...
      <c:forEach items="${ posts }" var="post" varStatus="boucle">
        <div class="card pb-2 mb-1 mx-auto px-0" style="width:35rem;">
          <div class="card-header">
            <nav class="navbar py-0 my-1" style="height:24px ! important">
    <!---->       <img class="navbar-brand profilePic ml-0" src = "ImgUploads/UserProfileImg/${post.user_profileImg}" />
    <!---->       <span class="navbar-nav text-muted mr-auto user_fullName">@${post.user_fullName}</span>
